...
console.log("It's " + hour + ":" + minute);

var colorshifta = document.getElementById("window1");
colorshifta.style.animationDuration = "86400s";
colorshifta.style.animationDelay = -hour * 3600 + "s";
